...
from model.analysis_record_model import AnalysisRecord
...
class AnalysisRepository:
    ...
    def save_analysis_record(
        ...
        try:
            ...
            self.logger.success(f"Registro guardado exitosamente con UUID: {record.uuid}")
            return record
            ...
            raise Exception(f"Error de MongoDB: {str(e)}")
